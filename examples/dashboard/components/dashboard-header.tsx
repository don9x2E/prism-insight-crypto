...
interface DashboardHeaderProps {
  activeTab: "dashboard" | "ai-decisions" | "trading" | "watchlist" | "insights" | "jeoningu-lab" | "crypto-benchmark"
  onTabChange: (tab: "dashboard" | "ai-decisions" | "trading" | "watchlist" | "insights" | "jeoningu-lab" | "crypto-benchmark") => void
  lastUpdated?: string
  market?: Market
        ...
        <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden sm:flex items-center">
              <div className="flex bg-muted/50 rounded-xl p-1.5 gap-1">
                <button
                  ...
                  className={`
                    flex cursor-pointer items-center gap-2 px-5 py-2.5 rounded-lg font-semibold text-sm transition-all duration-200
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="flex cursor-pointer items-center gap-1.5 px-3 py-1.5 rounded-lg bg-muted/50 hover:bg-muted transition-colors font-medium text-sm"
            >
          ...
          <div className="sm:hidden flex flex-col items-center gap-2 pb-3">
            <div className="flex bg-muted/50 rounded-xl p-1 gap-1 w-full max-w-sm">
              <button
                onClick={() => onMarketChange("KR")}
                className={`
                  flex-1 flex cursor-pointer items-center justify-center gap-2 px-4 py-2 rounded-lg font-semibold text-sm transition-all
                  ${market === "KR" && !isCryptoTab
